...
//	}
	...
	public static void updateResult(int indexSI, String testCaseName, Boolean testCaseStatus, String scriptName) throws IOException {
		String startDateTime = new SimpleDateFormat("MM-dd-yyyy_HH-ss").format(new GregorianCalendar().getTime());

		String userDirector = System.getProperty("user.dir");

		String resultFile = userDirector + "//TestHtmlReport.html";
		...
		if (indexSI == 1) {
			...
			bw1.write("<td  bgcolor='#CCCCFF' align='left'><b><font color='#000000' face='Tahoma' size='2'>Test Description </font></b></td>");
