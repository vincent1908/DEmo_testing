...
public class Reporter {
	...
	private static final String templatePath = System.getProperty("user.dir")+"//report_template.html";
	...
	public static void writeResults(String testName) {
		try {
			...
			String reportPath = System.getProperty("user.dir") + currentDate + testName+".html";
