...
public class demofunction extends demo {
	...
	public static void sendreq(String Temperature, String FromUnit, String ToUnit) throws Exception {
		...
		mimeHeader.setHeader("SOAPAction", "http://www.webserviceX.NET/ConvertTemp");

		SOAPBody soapBody = soapEnvelope.getBody();
		QName bodyName = new QName("http://www.webserviceX.NET/", "ConvertTemp", "web");
		SOAPBodyElement bodyElement = soapBody.addBodyElement(bodyName);

		QName n = new QName("http://www.webserviceX.NET/", "Temperature", "web");
		QName n1 = new QName("http://www.webserviceX.NET/", "FromUnit", "web");
		QName n2 = new QName("http://www.webserviceX.NET/", "ToUnit", "web");
		...
		// Sending request
		String endUrl = "http://www.webservicex.net/ConvertTemperature.asmx ";
		soapResponseMessage = soapConnection.call(soapMessage, endUrl);
	}
	...
	public static Document loadXMLString(String source) throws Exception {
		...
		InputSource is = new InputSource(new StringsourceReader());
